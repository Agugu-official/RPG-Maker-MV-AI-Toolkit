...
export const ReorderPluginTool: Tool = {
  name: "reorder-plugin",
  description: "Change the load order of a plugin in js/plugins.js. Plugin load order is critical in RPG Maker MV/MZ; compatibility layers must load before the plugins they extend.",
  inputSchema: {
    type: "object",
    properties: {
